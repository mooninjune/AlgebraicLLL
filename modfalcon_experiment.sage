...
# k=2
qs = [ next_prime(round(p)) for p in [ 2**10, 2**10.4, 2**10.8, 2**11.2, 2**11.6, 2**12.0, 2**13 ] ] * tests_per_q
f=128
k=2
manual_descend = 0
...
# k=3
qs = [ next_prime(round(p)) for p in [ 2**16.2, 2**16.5, 2**16.8, 2**17.1, 2**17.4, 2**17.7, 2**18.0 ] ] * tests_per_q
f=128
k=3
manual_descend = 0
